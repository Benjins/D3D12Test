...
void DoRendering(D3D12System* System)
{
	...
	ID3D12CommandAllocator* CommandAllocator = System->CmdListReclaimer.GetOpenCommandAllocator();
	...
	ID3D12GraphicsCommandList* CommandList = System->CmdListReclaimer.GetOpenCommandList(CommandAllocator);
	...
	System->CmdListReclaimer.CheckIfFenceFinished(System->FrameFence->GetCompletedValue());
